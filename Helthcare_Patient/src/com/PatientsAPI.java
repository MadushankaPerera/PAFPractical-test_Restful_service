...
public class PatientsAPI extends HttpServlet {
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = patientobj.updatePatient(paras.get("hidPatientIDSave").toString(),
				paras.get("firstName").toString(), paras.get("lastName").toString(), paras.get("fullName").toString(),
				paras.get("address").toString(), paras.get("sex").toString(), paras.get("cNumber").toString(),
				paras.get("age").toString(), paras.get("nic").toString(), paras.get("dob").toString());
