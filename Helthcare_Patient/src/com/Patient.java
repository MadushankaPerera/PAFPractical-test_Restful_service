...
public class Patient {
	...
	public String readPatients()
	{
		...
		try
		{
			...
			while (rs.next()) 
			{
				...
				output += "<tr><td><input id='hidPatientIDUpdate' name='hidPatientIDUpdate' type='hidden' value='" + patientID + "'>" + firstName + "</td>";
				...
				output += "<td><input name='btnUpdate' type='button' value='Update' class='btnUpdate btn btn-secondary'></td>"
							+ "<td><input name='btnRemove' type='button' value='Remove' class='btnRemove btn btn-danger' data-patietID='" + patientID + "'>" + "</td></tr>";    
	...
	public String insertPatient(String fname, String lname,String funame, String add, String sex, String cNum, String age, String nic, String dob) 
	{
		...
		try
		{
			...
			//Insert Query
			String query = " INSERT INTO patienttable (`firstName`, `lastName`, `fullName`, `address`, `sex`, `cNumber`, `age`, `nic`, `dob`)" + " values (?, ?, ?, ?, ?, ?, ?, ?, ?)";   
	...
	public String updatePatient(String fname, String lname,String funame, String add, String sex, String cNum, String age, String nic, String dob)
	{
